        ...
        <div class="row">
            ...
            <div class="col-xl-4 col-md-6 col-lg-4">
                <div class="single_property">
                    ...
                    <div id="carouselExampleControls{{$offre->id}}" class="carousel slide" data-ride="carousel">
                            ...
                            <a class="carousel-control-prev" href="#carouselExampleControls{{$offre->id}}" role="button" data-slide="prev">
                              <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                              <span class="sr-only">Previous</span>
                            </a>
                            <a class="carousel-control-next" href="#carouselExampleControls{{$offre->id}}" role="button" data-slide="next">
                    ...
                    <div class="property_content">
                        <div class="main_pro">
                        <h3><div class="font-weight-normal"><strong>Description :</strong>{{$offre->description}}</div></h3>
                                <div class="mark_pro">
                                ...
                                <div class="mark_pro">
                                    ...
                                    <span> {{$offre->telephone}}</span>
                                </div>
                                <div class="mark_pro">
                                    <i class="fa fa-usd" aria-hidden="true"></i>
                                    <span> prix :{{$offre->prix}} MAD</span>
                                </div>
                    ...
                    <div class="footer_pro ">
                            <ul class="bg-black">
                                <li>
                                    <div class="single_info_doc">
                                        ...
                                        <span>surface <span> {{$offre->superficie}}  </span></span>
                                    </div>
                                </li>
                                <li>
                                    <div class="single_info_doc">
                                        <i class="fa fa-users" aria-hidden="true"></i>
                                        <span><strong>capacite</strong>{{$offre->capacite}}</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="mark_pro">
                        ...
                        @if($userId==$offre->user_id)
                        <form action="{{route('offre.delete',$offre['id'])}}" method="POST">
                            @csrf
                           
                        <button class="btn btn-danger btn-sm-12" >
                            <span >delete</span></a>
                        </button>
                        </form>
                        @endif
